...
export function Register() {
  return (
    <div>
      <h3 className="text-xl font-medium mb-4 text-gray-900">Create novel account</h3>
      <Card className="p-6">
        <form className="space-y-5">
          <div>
            <label className="block text-sm font-medium text-gray-700">Full Name</label>
            <input type="text" className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-medical-blue focus:ring-medical-blue sm:text-sm p-2.5 border bg-white" placeholder="Dr. Jane Smith" />
          </div>
          <div>
